/*@brief: Controller for the different routes related to the reading, writing, updating and deletion of posts
...
router.patch('/:id', auth, updatePost);       //:id means it takes in an id, so in the case of localhost:5000/posts/123123, 123123 is the id
router.delete('/:id', auth, deletePost);    //use of middleware to verify active user token
