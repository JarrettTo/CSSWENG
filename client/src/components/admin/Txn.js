    ...
    */
    ...
    return(
        <Card className={classes.card}>
            ...
            <Typography className={classes.text}>{txn.dlsu_id ? "ID :" + txn.dlsu_id : null}</Typography>
            <Typography className={classes.text}>{txn.college ? "College :" + txn.college : null}</Typography>
            ...
            {txn.status == 'Accepted'  ? (<Button className={classes.button2} type="submit"  variant="contained" onClick={decline}>Decline</Button>): null}
